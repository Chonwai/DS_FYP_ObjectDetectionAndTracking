...
# __C.YOLO.CLASSES              = "./data/classes/super8.names"
# __C.YOLO.CLASSES              = "./data/classes/clothes.names"
# __C.YOLO.CLASSES              = "./data/classes/coco80.names"
__C.YOLO.CLASSES              = "./data/classes/person.names"
__C.YOLO.HELMET_CLASSES       = "./data/classes/helmet.names"
__C.YOLO.CLOTHES_CLASSES      = "./data/classes/clothes.names"
