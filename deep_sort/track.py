...
class Track:
    ...
    track_id : string
        A unique track identifier(UUID).
    n_init : int
    ...
    def __init__(self, mean, covariance, track_id, color, n_init, max_age,
                 feature=None, class_name=None, stateInArea= None, noConsider = None):
        self.mean = mean
        ...
        self.stateInArea = None
        if stateInArea is not None:
            # State of not being counted again passing the line
            self.stateInArea = stateInArea
